...
Basic Memory is the durable curated knowledge base.

- Recall it when previous decisions, preferences, project history, known
...
- When durable knowledge is discovered or corrected, update the canonical note
  rather than creating a session summary.
